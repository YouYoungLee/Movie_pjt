...
export default {
  ...
  data() {
    ...
    created() {
      this.user1_id = this.$route.params.User_id
  ...
  methods: {
    getChatDetail() {
      console.log(this.user2_id, this.user1_id, ";;;;;;;;;;;;;;")
      console.log(this.user2_id, "222222222222")
      axios({
        method: "get",
        url: `${API_URL}/api/v4/${this.user2_id}/${this.user1_id}`,
        headers: {
        ...
        .then((res) => {
          console.log((this.room_id = res.data.id))
          this.getMessageDetail2()
          console.log(this.room_id, "룸아이디 확인")
        })
        .catch((err) => {
          console.log(err)
          axios({
            method: "get",
            url: `${API_URL}/api/v4/${this.user1_id}/${this.user2_id}`,
            headers: {
              Authorization: `Token ${this.token}`,
              // Authorization: `Token 5bf38fd3b0616df0e87b182307ab0de78b7411f1`,
            },
            ...
            .catch((err) => {
              ...
              axios({
                method: "post",
                url: `${API_URL}/api/v4/create/${this.user1_id}/`,
                headers: {
                  Authorization: `Token ${this.token}`,
                  // Authorization: `Token 5bf38fd3b0616df0e87b182307ab0de78b7411f1`,
                },
